class Admin::ProductsController < ApplicationController
	...
	def destroy
		if current_user.admin
			if	@product.destroy
				redirect_to admin_categories_path, notice: "Supprimé avec succès"
			else
	...
	def params_product
		params.require(:product).permit(:title, :brand, :description, :price, :category_id, :color, { attachments:[]}, sizes_attributes: [:id, :size_name, :quantity, :_destroy])
	end
end